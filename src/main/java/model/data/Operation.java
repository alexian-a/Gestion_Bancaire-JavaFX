...
public class Operation {
    ...
    /**
     * Contructeur qui prend 2 comptes pour les virements
     *
     * @author Romy Chauvière
     */
    public Operation(int idOperation, double montant, Date dateOp, Date dateValeur, int idNumCompte, String idTypeOp, int idNumCompte2) {
        this(idOperation, montant, dateOp, dateValeur, idNumCompte, idTypeOp);
        this.idNumCompte2 = idNumCompte2;
    }
